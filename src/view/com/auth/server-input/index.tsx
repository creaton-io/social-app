      ...
      <View style={[a.relative, a.gap_md, a.w_full]}>
        ...
        <ToggleButton.Group
          ...
          <ToggleButton.Button name={BSKY_SERVICE} label={_(msg`Creaton`)}>
            <ToggleButton.ButtonText>{_(msg`Creaton`)}</ToggleButton.ButtonText>
          </ToggleButton.Button>
          <ToggleButton.Button
        ...
        {fixedOption === BSKY_SERVICE && isFirstTimeUser && (
          <Admonition type="tip">
            <Trans>
              Creaton is an open network where you can choose your own provider.
              If you're new here, we recommend sticking with the default Creaton
              Social option.
            </Trans>
          </Admonition>
        )}
        ...
        <View style={[a.py_xs]}>
          <P
            ...
            {isFirstTimeUser ? (
              ...
              <Trans>
                Creaton uses AT Protocol where you can choose your hosting
